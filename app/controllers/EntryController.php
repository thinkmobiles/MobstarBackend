...
//						$file->move( $_ENV[ 'PATH' ] . 'public/uploads/', 'testorientation.' . $extension );
						...
						// Transcode Video
						shell_exec( '/usr/bin/ffmpeg -i ' . $file_in . ' -strict -2 -vf scale=305:306 ' . $file_out );
						...
						shell_exec( '/usr/bin/ffmpeg -i ' . $file_out . ' -vf transpose=1  -vframes 1 -an -s 300x300 -ss 00:00:00.10 ' . $thumb );
