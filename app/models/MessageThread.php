...
class MessageThread extends \Eloquent {
	protected $fillable = ["message_thread_id", "message_thread_created_data"]; 
    ...
    public function messages(){
        return $this->hasMany('Message2', 'message_thread_id', 'message_thread_thread_id');
    }

    public function messageRecipients(){
        return $this->hasMany('MessageRecipients', 'join_message_recipient_message_thread_id', 'message_thread_thread_id');
    }
