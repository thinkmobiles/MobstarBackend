...
{
    const ENV_KEY = 'AKIAIE4TLASFISDQDHPA';
    const ENV_SECRET = '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';
    const ENV_SECRET_ACCESS_KEY = 'kJ08W+zwlTUlcpvI7bklngIu6X3ZrI04BApQXwuw';
